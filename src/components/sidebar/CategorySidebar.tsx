...
// src/components/sidebar/CategorySidebar.tsx
"use client";
...
export default function CategorySidebar() {
  ...
  // (… keep your focus/keyboard code unchanged …)

  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && closeSidebar()}>
      <SheetContent side="left" className="p-0 pt-5 w-auto max-w-none bg-[#6A4EF5] text-primary-foreground border-none [&>button]:hidden">
        <SidebarHeader />
